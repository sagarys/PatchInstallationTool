    ...
    public partial class MainWindow : Window
    {
        ...
        public void Get_Patch_Details()
        {
            ...
            System.IO.StreamReader file =
                new System.IO.StreamReader("FIT102195611.ps");
            while ((line = file.ReadLine()) != null)
            {
                if (line.Contains("Prerequisites"))
                {
                    ...
                    txtPreReq.Text = prereqlist;
                    break;
                }
            }
        }
        public void GetProdNameFromRelNotes()
        {
            string line;

            // Read the file and display it line by line.  
            System.IO.StreamReader file =
                new System.IO.StreamReader("relnotes.txt");
            while ((line = file.ReadLine()) != null)
            {
                if (line.Contains("Product"))
                {
                    var prodName = line.Split(':').Last();
                    cboProducts.SelectedValue = prodName.Replace(" ",""); 
                    break;
                }
            }
